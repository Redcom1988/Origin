...
namespace Origin.Items.Projectile
{
	public class JarateJar : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("JarateJar");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.MolotovCocktail;           //Act exactly like default Bullet
		}
